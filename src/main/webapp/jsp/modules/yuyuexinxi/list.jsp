...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yuyuezhuangtai')">预约状态<i id="yuyuezhuangtaiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yuyuezhuangtaiCell  = document.createElement('td');

						  yuyuezhuangtaiCell.innerHTML = item.yuyuezhuangtai; 

			row.appendChild(yuyuezhuangtaiCell);
