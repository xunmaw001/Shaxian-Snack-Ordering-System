...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>预约状态</label>
										<select id="yuyuezhuangtaiSelect" name="yuyuezhuangtai" class="form-control">
												<option value=""></option>
												<option class="yuyuezhuangtaiOption" value="打包">
													打包
												</option>
												<option class="yuyuezhuangtaiOption" value="店内就餐">
													店内就餐
												</option>
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>个人账号</label>
										<input id="gerenzhanghao" name="gerenzhanghao" class="form-control" placeholder="个人账号">
									</div>
									<div class="form-group col-md-6">
										<label>姓名</label>
	...
	<script>
		...
		function dataBind(){
			...
			var yuyuezhuangtaiOptions = document.getElementsByClassName("yuyuezhuangtaiOption");
			for(var yuyuezhuangtaiCount = 0; yuyuezhuangtaiCount < yuyuezhuangtaiOptions.length;yuyuezhuangtaiCount++){
				if(yuyuezhuangtaiOptions[yuyuezhuangtaiCount].getAttribute('value') == ruleForm.yuyuezhuangtai){
					yuyuezhuangtaiOptions[yuyuezhuangtaiCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yuyuezhuangtai != null && res.data.yuyuezhuangtai != ''){

					var yuyuezhuangtaiOptions = document.getElementsByClassName("yuyuezhuangtaiOption");
						for(var yuyuezhuangtaiCount = 0; yuyuezhuangtaiCount < yuyuezhuangtaiOptions.length;yuyuezhuangtaiCount++){
							if(yuyuezhuangtaiOptions[yuyuezhuangtaiCount].getAttribute('value') == res.data.yuyuezhuangtai){
								yuyuezhuangtaiOptions[yuyuezhuangtaiCount].setAttribute('selected','selected');
							}
						}
					}
