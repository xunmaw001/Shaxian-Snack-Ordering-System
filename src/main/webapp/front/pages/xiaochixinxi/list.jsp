          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="mendianmingcheng" id="mendianmingcheng" placeholder="门店名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">小吃名称</label>
              <div class="layui-input-inline">
                <input type="text" name="xiaochimingcheng" id="xiaochimingcheng" placeholder="小吃名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">小吃类型</label>
              <div class="layui-input-inline">
                <input type="text" name="xiaochileixing" id="xiaochileixing" placeholder="小吃类型" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('xiaochixinxi','新增')" @click="jump('../xiaochixinxi/add.jsp')" type="button" class="layui-btn btn-theme">
          ...
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../xiaochixinxi/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.meishitupian?item.meishitupian.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#xiaochimingcheng').val()) {
          param['xiaochimingcheng'] = jquery('#xiaochimingcheng').val() ? '%' + jquery('#xiaochimingcheng').val() + '%' : '';
        }  
        if (jquery('#xiaochileixing').val()) {
          param['xiaochileixing'] = jquery('#xiaochileixing').val() ? '%' + jquery('#xiaochileixing').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('xiaochixinxi/list', 'get', param, function(res) {
