        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('mendianxinxi','新增')" @click="jump('../mendianxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
          ...
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../mendianxinxi/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.mendiantupian?item.mendiantupian.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#mendiandizhi').val()) {
          param['mendiandizhi'] = jquery('#mendiandizhi').val() ? '%' + jquery('#mendiandizhi').val() + '%' : '';
        }  
        // 获取列表数据
