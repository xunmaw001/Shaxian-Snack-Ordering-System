				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('mendianxinxi','发布小吃')" @click="onAcrossTap('xiaochixinxi')" type="button" class="layui-btn">
								发布小吃
							</button>
																					<button v-if="isAuth('mendianxinxi','预约')" @click="onAcrossTap('yuyuexinxi')" type="button" class="layui-btn">
								预约
							</button>
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					...
					vue.detail = res.data
																									vue.title = vue.detail.mendianmingcheng;
																																																		// 轮播图片
					vue.swiperList = vue.detail.mendiantupian ? vue.detail.mendiantupian.split(",") : [];
																																													var swiperItemHtml = '';
